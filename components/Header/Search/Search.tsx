    ...
    <div className="flex items-center relative w-auto">
      ...
      <div className="relative w-full">
        ...
        <input
          ...
          className="w-0 bg-gray-50 border-2 border-blue-200 text-slate-700 text-sm rounded-xl outline-none block pl-10 p-2.5 transition-all focus:border-blue-700 focus:w-36 sm:w-[140px] xs:focus:w-56 sm:focus:w-56"
          placeholder="Search"
        />
      </div>
      {list && (
