...
import { Contact, ContactsPageProps } from "../pageInterfaces/ContactsPageProps"
            ...
            <motion.div animate={{ y: [-1000, 0] }} >
                {
                    contactList.map((contact: Contact) => (
                        < div key={contact.id} className="text-center mx-auto py-3 flex flex-col gap-2 max-w-5xl border-b-2" >
...
export const getStaticProps: GetStaticProps = async () => {
    ...
    const contactList = data.slice(0, 3)
