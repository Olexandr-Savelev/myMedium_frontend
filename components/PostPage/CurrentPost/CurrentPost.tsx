  ...
  return (
    <div className="flex flex-col p-3 w-full border-[1px] border-slate-400 my-4 shadow-md sm:p-8">
      ...
      <div className="flex flex-col gap-4 items-center mt-3">
        ...
        <button
          className="text-white bg-blue-700 hover:bg-blue-800 font-semibold rounded-lg text-sm px-5 py-2.5 text-center uppercase cursor-pointer block w-full sm:w-auto disabled:cursor-auto disabled:bg-blue-300 disabled:hover:bg-blue-300"
          onClick={() => {
            setIsModalOpen(true);
          }}
